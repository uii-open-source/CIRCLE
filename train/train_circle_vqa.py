...
trainer = CIRCLETrainer(
    ...
    data_folder='data/image',  # folder containing all patient CT data
    vqa_json='data/vqa.json',  # json file mapping image names to vqa
    lung_center_csv='data/lung_center.csv',  # CSV file with lung center coordinates for cropping
    ...
    results_folder="output/vqa_model",  # Directory to save training results
)
